    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          console.log('Explicit provider injected.');

          _context.next = 8;
          return (0, _effects.put)({ type: 'WEB3_INTIALISED' });
