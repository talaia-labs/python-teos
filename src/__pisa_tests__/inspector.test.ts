...
const nodeLocation = "ws://localhost:8545";
let socketProvider = new WebsocketProvider(nodeLocation);
const web3 = new Web3x(socketProvider);
...
describe("Inspector", () => {
    ...
    it("watch a contract", async () => {
        const inspector = new Inspector(web3, 10, provider);
