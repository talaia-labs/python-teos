...
_REGISTERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='teos.protobuf.protos.v1.RegisterRequest.user_id', index=0,
...
_REGISTERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='teos.protobuf.protos.v1.RegisterResponse.user_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='available_slots', full_name='teos.protobuf.protos.v1.RegisterResponse.available_slots', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='subscription_expiry', full_name='teos.protobuf.protos.v1.RegisterResponse.subscription_expiry', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='subscription_signature', full_name='teos.protobuf.protos.v1.RegisterResponse.subscription_signature', index=3,
...
_GETUSERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='teos.protobuf.protos.v1.GetUserRequest.user_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETUSERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user', full_name='teos.protobuf.protos.v1.GetUserResponse.user', index=0,
...
_GETUSERSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user_ids', full_name='teos.protobuf.protos.v1.GetUsersResponse.user_ids', index=0,
